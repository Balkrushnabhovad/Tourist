...
<body>
    ...
    <div class="slider_area">
        <div class="slider_active owl-carousel">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="travel_destination.php" class="boxed-btn3">Explore Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                <h3>Arabia</h3>
                                <p>Fear is only temporary. Regrets last forever</p>
                                <a href="travel_destination.php" class="boxed-btn3">Explore Now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_8 overlay">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_9 overlay">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_10 overlay">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            <div class="newsletter_btn">
                                                <button class="boxed-btn4" type="submit" name="emailsubscribe">Subscribe</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            ...
                            <a href="#" class="prise">₹ 38,165.80</a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.php"><h3>Our Upscoming Trip <br>Saintmartine Iceland</h3></a>
                            <p>United State of America</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-12">
                    <div class="video_wrap text-center">
                        ...
                        <div class="video_icon">
                            <a class="popup-video video_play_button" href="https://www.youtube.com/watch?v=VVsC2fD1BjA">
